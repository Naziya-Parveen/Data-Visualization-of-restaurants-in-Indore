...
output_filename = 'location.csv'
# Set your input file here
input_filename = "vijaynagardelivery_.csv"
...
#addresses = (data[address_column_name] + ',' + data['Country'] + ',India').tolist()
addresses = (data[address_column_name] + ',India').tolist()
